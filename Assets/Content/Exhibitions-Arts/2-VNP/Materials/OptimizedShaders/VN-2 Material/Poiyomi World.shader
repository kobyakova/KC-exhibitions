Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi World/20036225ad7ac354399fad07cf614bd9"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDithering(inout PoiFragData poiFragData, in PoiCam poiCam)
			{
				...
				{
					float dither = calcDither(poiCam.screenUV.xy) - (0.389 /*_AlphaDitherBias*/);
					poiFragData.alpha = saturate(poiFragData.alpha - (dither * (1 - poiFragData.alpha) * (0.294 /*_AlphaDitherGradient*/)));
				}
			}
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				+ (0.0 /*_DissolveAlpha8*/)
				+ (0.0 /*_DissolveAlpha9*/);
				float dds = (0.312 /*_DissolveDetailStrength*/);
				...
				#if defined(PROP_DISSOLVEDETAILNOISE) || !defined(OPTIMIZER_ENABLED)
				float dissolveDetailNoise = POI2D_SAMPLER_PAN(_DissolveDetailNoise, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DissolveDetailNoiseUV*/)], float4(4,2,0,0)), float4(0,0,0,0));
				#else
				...
				switch((2.0 /*_DissolveType*/))
				{
					...
					{
						da = remap(da, 0, 1, -(0.114 /*_DissolveEdgeWidth*/), 1);
						dissolveAlpha = da;
						...
						edgeAlpha = remapClamped(da + (0.114 /*_DissolveEdgeWidth*/), da, noise) * (1 - dissolveAlpha);
						break;
					}
					case 2: // Point to Point
					{
						...
						float3 currentPos;
						float distanceTo = 0;
						direction = normalize(float4(0,0,0,0) - float4(0,1.5,0,0));
						currentPos = lerp(float4(0,1.5,0,0), float4(0,0,0,0), dissolveAlpha);
						
						if ((1.0 /*_DissolveP2PWorldLocal*/) != 1)
						{
							float3 pos = (1.0 /*_DissolveP2PWorldLocal*/) == 0 ? poiMesh.localPos.rgb : poiMesh.vertexColor.rgb;
							distanceTo = dot(pos - currentPos, direction) - dissolveDetailNoise * dds;
							edgeAlpha = smoothstep((0.09 /*_DissolveP2PEdgeLength*/) + .00001, 0, distanceTo);
					...
					case 3: // Spherical
					{
						...
						{
							da = remap(da, 1, 0, -(0.114 /*_DissolveEdgeWidth*/), 1);
						} else {
							da = remap(da, 0, 1, -(0.114 /*_DissolveEdgeWidth*/), 1);
						}
						dissolveAlpha = da;
						...
						if((0.0 /*_SphericalDissolveInvert*/))
						{
							...
							edgeAlpha = smoothstep((0.114 /*_DissolveEdgeWidth*/) + .00001, 0, -normalizedDistance);
						} else {
							dissolveAlpha = (normalizedDistance < 0) ? 1 : 0;
							edgeAlpha = smoothstep((0.114 /*_DissolveEdgeWidth*/) + .00001, 0, normalizedDistance);
						}
					...
					case 4: // CenterOut
					{
						...
						float noise;
						[flatten]
						switch((3.0 /*_CenterOutDissolveMode*/))
						{
				...
				if ((0.114 /*_DissolveEdgeWidth*/) || ((2.0 /*_DissolveType*/) == 2 && (0.09 /*_DissolveP2PEdgeLength*/) != 0))
				{
					edgeColor = tex2D(_DissolveEdgeGradient, poiUV(float2(edgeAlpha, edgeAlpha), float4(1,1,0,0))) * float4(poiThemeColor(poiMods, float4(0.7230552,0.5573749,0.3744739,0).rgb, (0.0 /*_DissolveEdgeColorThemeIndex*/)), float4(0.7230552,0.5573749,0.3744739,0).a);
					#ifndef POI_SHADOW
					...
					#endif
					poiFragData.baseColor = lerp(poiFragData.baseColor, edgeColor.rgb, smoothstep(0, 1 - (0.525 /*_DissolveEdgeHardness*/) * .99999999999, edgeAlpha));
				}
				poiFragData.emission += lerp(0, dissolveToTexture * (0.0 /*_DissolveToEmissionStrength*/), dissolveAlpha) + lerp(0, edgeColor.rgb * (0.0 /*_DissolveEdgeEmission*/), smoothstep(0, 1 - (0.525 /*_DissolveEdgeHardness*/) * .99999999999, edgeAlpha));
				#endif
			}
			#endif
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				clip(poiFragData.alpha - (0.376 /*_Cutoff*/));
